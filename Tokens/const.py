...
__TOKEN_BG = {
        ...
        None:Image.open(rf'{ROOT_DIR}resources\backgrounds\token_bg.png').resize((IMG_SIZE,IMG_SIZE))
} | {
    # group:Image.open(rf'{ROOT_DIR}resources\backgrounds\{group}_token_bg.png').resize((512,512)) for group in groups
    group:Image.open(rf'{ROOT_DIR}resources\backgrounds\{group}_token_bg.png').resize((IMG_SIZE,IMG_SIZE)) for group in groups
}
...
__REMINDER_BG = Image.open(rf'{ROOT_DIR}resources\backgrounds\reminder_bg.png').resize((REMINDER_SIZE,REMINDER_SIZE))
def REMINDER_BG():
...
__TOP_LEAF = {
    None:[Image.open(rf'{ROOT_DIR}resources\leaves\top_leaf_{k}.png').resize((IMG_SIZE,IMG_SIZE)) for k in range(1,MAX_LEAVES_GROUP[None]+1)]
    ...
    group:[Image.open(rf'{ROOT_DIR}resources\leaves\{group}_top_leaf_{k}.png').resize((IMG_SIZE,IMG_SIZE)) for k in range(1,MAX_LEAVES_GROUP[group]+1)] for group in groups
}
...
__LEFT_LEAF = {
        ...
        None:Image.open(rf'{ROOT_DIR}resources\leaves\left_leaf.png').resize((IMG_SIZE,IMG_SIZE))
} | {
    # group:Image.open(rf'{ROOT_DIR}resources\leaves\{group}_left_leaf.png').resize((512,512)) for group in groups
    group:Image.open(rf'{ROOT_DIR}resources\leaves\{group}_left_leaf.png').resize((IMG_SIZE,IMG_SIZE)) for group in groups
}
...
__RIGHT_LEAF = {
        ...
        None:Image.open(rf'{ROOT_DIR}resources\leaves\right_leaf.png').resize((IMG_SIZE,IMG_SIZE))
} | {
    # group:Image.open(rf'{ROOT_DIR}resources\leaves\{group}_right_leaf.png').resize((512,512)) for group in groups
    group:Image.open(rf'{ROOT_DIR}resources\leaves\{group}_right_leaf.png').resize((IMG_SIZE,IMG_SIZE)) for group in groups
}
...
__ORANGE_LEAF = {
        ...
        None:Image.open(rf'{ROOT_DIR}resources\leaves\orange_leaf.png').resize((IMG_SIZE,IMG_SIZE))
} | {
    # group:Image.open(rf'{ROOT_DIR}resources\leaves\{group}_orange_leaf.png').resize((512,512)) for group in groups
    group:Image.open(rf'{ROOT_DIR}resources\leaves\{group}_orange_leaf.png').resize((IMG_SIZE,IMG_SIZE)) for group in groups
}
